...
- [ ] 독립 코드 리뷰를 통과시키고 `dev` 대상 PR을 생성한다.

### 런타임 버그 수정 Review

- Node 24.20.0에서 `site/` Vitest 101개와 루트 참조 테스트 94개가 통과했고, typecheck·lint·DESIGN lint(errors 0, warnings 0)·Vinext production build·`git diff --check`가 통과했다.
