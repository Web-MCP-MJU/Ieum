...
- [x] **Step 1: Preserve the 27-section skeleton and replace identity/domain vocabulary**
...
- [x] **Step 2: Replace spatial, route, and rendering contracts**
...
- [x] **Step 3: Replace query, seat, and landmark contracts**
...
- [x] **Step 4: Replace the nine-tool common and per-tool contracts**
...
- [x] **Step 5: Review Task 2 as a coherent contract set**
...
- [x] **Step 1: Correct WebMCP adapter and runtime facts**
...
- [x] **Step 2: Synchronize state and human confirmation**
...
- [x] **Step 3: Synchronize UI and progressive enhancement**
...
- [x] **Step 4: Synchronize portability, tests, ADRs, and success criteria**
...
- [x] **Step 5: Synchronize challenge compliance without delivery planning**
...
- [x] **Step 6: Review Task 3 against PRD and official sources**
...
- [x] **Step 1: Run exact obsolete-contract scans**
...
- [x] **Step 2: Run required-contract scans and structural checks**
...
- [x] **Step 3: Inspect the full diff and run Markdown hygiene checks**
...
- [x] **Step 4: Dispatch independent final reviews**
